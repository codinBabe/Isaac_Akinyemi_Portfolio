    ...
    <>
        ...
        <div className="flex justify-center gap-4 my-3">
          ...
          <div>
            <p className="text-lg">
              ...
              discuss with youths who are eligible to vote about the low turnout
              of voters during the election and understand their attitude
            ...
            <p className="text-sm italic mb-4">
              The one-on-one research was done by myself, while some other team
              members joined in for the focus group sessions.
            </p>
            <AnchorTag
              classname={"text-primaryblue underline font-medium"}
      ...
      <SectionLayout className={"font-intertight"}>
        <div>
          ...
          <p className="text-lg font-medium -mt-10 mb-2">
            I never saw a reason to participate in the election as we already
            knew the winner. All I want is to do my business, make money, and
            leave this shithole. But then I remembered my friends and family and
            decided to do as little as I could by getting involved.
          </p>
        ...
        <div className="mt-10">
          ...
          <p className="text-lg font-medium mb-2 -mt-10">
            I believe in the power and judgement of the Nigerian people to elect
            credible and competent candidates when given access to the right
            information.
          </p>
      ...
      <SectionLayout className={"font-intertight mt-6"}>
        <div className="mb-8">
          ...
          <h2 className="font-grotesque text-2xl">Generation of insights</h2>
          <p className="text-lg">
            Insights were generated after listening to the recordings of the
            user interview sessions and collating data from the user research
            participants.
          </p>
        </div>
      ...
      <SectionLayout className={"font-intertight mt-2"}>
        <h2 className="font-grotesque text-2xl mb-1">Further research</h2>
        <div>
          <p>
            To validate and invalidate our assumptions and findings, we
            conducted surveys to acquire quantitative data from youths who are
            living in Nigeria. Over <b>54%</b> of the survey participants didn’t
            vote in previous elections, and more than <b>65%</b> of them are
            over <b>24 years</b>
            of age.
          </p>
          <p className="text-sm mt-1 italic">
            The criteria to vote is to be 18 years or older and have a voter’s
            card. Elections happen every 4 years.
          </p>
        </div>
      ...
      >
        ...
        <div className="mt-4 flex flex-col gap-4">
          <div className="flex items-start gap-4">
            <b>#1</b>
            <p>
              The youths are willing to participate in the election process, but
              they need a reason to, and be sure that the election will be
              credible.
            </p>
          </div>
          <div className="flex items-start gap-4">
            ...
            <p>
              ...
              election process before have made uninformed decisions and lack
          ...
          <div className="flex items-start gap-4">
            <b>#3</b>
            <p>
              The youths are ready to vote in the upcoming 2023 elections as the
              election body in Nigeria introduced a device used to upload and
              transmit election results in real-time.
            </p>
          </div>
          <div className="flex items-start gap-4 mb-5">
            <b>#4</b>
            <p>
              The youths can drive the change and impact they want, just like
              they did during the{" "}
              <AnchorTag
                classname={"text-primaryblue underline font-medium"}
                text={"End-SARS"}
      ...
      >
            ...
            <div className="flex items-start gap-1">
              ...
              <p>
                ...
                <span className="italic text-base">
                  {" "}
                  - PVC (permanent voters’ card) card issued to eligible voters.
                </span>
              </p>
            </div>
            <div className="flex items-start gap-1">
        ...
        <div className="bg-tintblue4 p-5 mt-4 mb-5">
          ...
          <div className="flex flex-col gap-4 mt-4 text-lg">
            ...
            <div className="flex items-start gap-1">
              <p>2.</p>
              <p>
                Resources on the website (posters and fliers were made available
      ...
      >
        ...
        <div className="mt-8 relative">
          ...
          <div className="bg-tintblue4 p-5 my-5">
      ...
      <SectionLayout className={"font-intertight mt-6"}>
        ...
        <p>
          Upon launching the website, we had a retrospective meeting and decided
          to organise a voter seminar at one of the top universities in Nigeria
          weeks before the elections. The government had ordered all schools to
          close down to increase the participation of youths in the election
          exercise. The university we used is in the <b>2nd</b> most populous
          state in Nigeria and one of the top universities in Nigeria.
        </p>
        <div className="my-4 flex flex-wrap items-center gap-4">
          <p className="bg-tintblue4 p-2 text-lg font-medium">Panel Session</p>
          ...
          <p className="bg-tintblue4 p-2 text-lg font-medium">Audience Q&A</p>
      ...
      >
        ...
        <div className="my-6">
          ...
          <p>
            ...
            their tuition fees in 2023. Some did over <b>300%</b>, while others
            did between <b>100%</b> and <b>200%</b>. We contacted the Obama
            Foundation via the Obama Leadership Network and submitted a project
            proposal to support self-funded students who are struggling
            financially due to the fee hikes and risk of dropping out.
          </p>
          <p className="mt-4">
