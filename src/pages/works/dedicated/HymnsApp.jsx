    ...
    <>
      ...
      <SectionLayout>
        ...
        <h2 className="font-grotesque text-[32px] leading-[36.8px]">
          Designing a <span className="text-secgpa1">hymns app</span> to foster
          digital <span className="text-secgpa2">devotion</span> and{" "}
      ...
      <SectionLayout
        className={"border-b border-tintblue1 font-intertight mt-6"}
      >
        <h4 className="text-sm">THE REAL ISSUE - PROBLEM STATEMENT</h4>
        <p className="mt-2 text-2xl">
          I went to a church vigil on a Friday in 2020, and it was time to sing
          a hymn.{" "}
        ...
        <h3 className="text-2xl font-grotesque mt-8">The process - My role</h3>
        <p>
          As a solo product designer on the project, I approached the problem
          using the <b>design thinking problem-solving</b> technique. I started
          with generative user research and analysis of the research findings to
          draw insights before ideating solutions and testing early concepts
        ...
        <ol className="list-decimal list-inside text-lg">
          <li>
            Easy access to hymnal songs and lyrics whenever it is time to sing
            one.
          </li>
          <li>Improve the retention of hymnal songs.</li>
          <li>
            Enhance digital devotion and togetherness during church services.
          </li>
        </ol>
        <div className="my-8">
          ...
          <div className="bg-tintblue4 p-5 mb-4 relative">
            <p>
              How might we encourage regular usage of the solution, ensuring it
              becomes an integral part of the church’s worship routine?
            </p>
            <div className="w-7 h-7 rounded-full bg-primaryblue p-2 font-semibold flex items-center justify-center text-white absolute right-0 top-0">
              3
            </div>
      ...
      >
        <h3 className="font-grotesque text-2xl">Who is the solution for?</h3>
        <p className="text-lg mt-2">
          The primary users are the members of the church community, individuals
          with varying technological proficiencies, age groups, and musical
          preferences. The app was designed with tech-savvy individuals and
          those less familiar with digital platforms in mind (inclusivity and
          accessibility).
        </p>
        ...
        <div className="bg-[#D9D9D9] w-80 h-80 rounded-3xl my-8 p-4 flex items-center justify-center">
          <p className="text-xl">
            Video of: the prototype, people testing the app, you navigating the
            app on Figma mobile app.
          </p>
        </div>
        <h3 className="text-2xl font-grotesque mt-8">The solution overview</h3>
        <p className="text-lg mt-2">
          A mobile app with features such as categorisation of hymnal songs, a
          search feature, audio accompaniments, save as favourite, and the daily
          rhema section.
        </p>
        <p className="text-sm italic">
          The daily rhema is a daily devotional book providing daily readings,
          reflections, and prayers to guide one’s spiritual journey.
        </p>
        <h3 className="text-2xl font-grotesque mt-8">Result</h3>
        <p className="text-lg mt-2 mb-8">
          <b>75%</b> of the moderated usability study participants thought the
          app was live and wanted to install it on their mobile devices
          immediately.
        </p>
      </SectionLayout>
      <SectionLayout
      ...
      >
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-2 gap-4 bg-tintblue4 px-4 py-8 rounded-[24px]">
        ...
        <div className="my-8">
          ...
          <div className="flex flex-col gap-10 bg-tintblue4 px-4 py-8 rounded-[24px]">
            <div>
      ...
      >
        ...
        <div className="mt-8">
          ...
          <div className="mt-8">
            ...
            <div>
              <img src={HymnsImages.designIteration1} alt="design iteration" />
            </div>
          ...
          <div className="font-medium mt-8">
            ...
            <div>
              <img src={HymnsImages.designIteration2} alt="design iteration" />
            </div>
            <p className="font-medium mt-4">
              ==&gt; The language switch was removed, and indicators were added.
            </p>
          </div>
          <div className="mt-8">
            <h3 className="font-grotesque text-2xl mb-4">Before #2</h3>
            <div>
              <img src={HymnsImages.designIteration3} alt="design iteration" />
            </div>
          ...
          <div className="mt-8">
            ...
            <div>
              <img src={HymnsImages.designIteration4} alt="design iteration" />
            </div>
            <p className="font-medium mt-4">
          ...
          <div className="mt-8">
            ...
            <div>
              <img src={HymnsImages.designIteration5} alt="design iteration" />
            </div>
            <p className="font-medium mt-4">==&gt; Use of segmented buttons.</p>
          </div>
          <div className="mt-8">
            <h3 className="font-grotesque text-2xl mb-4">After #3</h3>
            <div>
              <img src={HymnsImages.designIteration6} alt="design iteration" />
            </div>
      ...
      >
        <div>
          ...
          <p className="text-lg">
            The visual elements used in the mockups were based on the church's
            visual and brand identity i.e. Logo.
          </p>
          <div className="mt-6">
        ...
        <div className="my-8">
          ...
          <div className="flex flex-col items-center gap-4 mt-6 bg-tintblue4 py-6 px-4 rounded-[24px]">
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
            ...
            <div>
              <h4 className="text-sm uppercase font-medium mb-4">all hymns</h4>
        ...
        <div className="bg-tintblue4 p-5 rounded-[4px] text-lg mt-8">
          <h3 className="font-grotesque text-2xl">Technical considerations</h3>
          <p className="my-2">
            One of the issues might be getting images to use for the cards.
            Using a pool of images and repeating images should work.
          </p>
          <p>
            Also, the Daily Rhema is only available in English for now, so there
            is no translation available for it. The languages used in all
            branches of the church and in combined services are English and
            Yoruba.
          </p>
        </div>
        <div className="text-lg">
          <h3 className="font-grotesque text-2xl mt-8">
          ...
          <div className="flex flex-col gap-6 mt-4">
            <div>
              <div className="flex items-start gap-4 mb-4">
                <b>✔</b>
                <p>Use of labels on navigator to make navigation easier</p>
              </div>
              <img src={HymnsImages.accessibility} alt="accessibility" />
            </div>
            <div className="mb-4">
              <div className="flex items-start gap-4 mb-4">
                <b>✔</b>
                <p>
                  ...
                  <AnchorTag
                    ...
                    link={""}
                    classname={"text-sm text-primaryblue underline font-medium"}
                  />
                </p>
              </div>
              <img src={HymnsImages.colorcontrast} alt="color-contrast" />
            </div>
          </div>
        </div>
      </SectionLayout>
