...
const Aside = () => {
  ...
  return (
    <>
      ...
      {!isModalOpen && (
        <div className="bg-tintblue3 fixed lg:static left-0 top-0 z-10 w-full lg:w-auto">
          <div className="flex items-center justify-between p-4">
            ...
            <button
              ...
              className="text-primaryblue text-sm font-semibold underline lg:hidden"
            >
              See more
            </button>
          </div>
          <div className="hidden lg:block p-4">
            <ul className="info-list list-disc">
              ...
              <li>
                Worked in FinTech, eCommerce, PropTech, and EduTech industries.
              </li>
              <li>
                Currently bridging the gap between business goals and user needs
                at{" "}
                <AnchorTag
                  classname={"text-primaryblue underline font-medium"}
                  text={"Ecobank Transnational Incorporated"}
